...
class DoctorEdit extends Component {
    ...
    state = {
        userinfo:{
            ...
            lastname: cookies.get("apellido"),
            email: cookies.get("correo"),
            speciality: cookies.get("especialidad"),
            phone: cookies.get("telefono"),
            document_type:cookies.get("document_type"),
    ...
    render(){
        ...
        <>
        {cookies.get("type_user") == 1 ?  <NavigationAdmin name={cookies.get("nombre")+' '+cookies.get("apellido")}/>
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-lg-12 mx-auto mb-0">
                                    ...
                                    <button type="submit" className="btn btn-primary btn-block py-2">
                                        <span className="font-weight-bold">Cambiar datos</span>
                                    </button>
                            </div>
