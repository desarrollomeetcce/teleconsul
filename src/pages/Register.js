...
const url ='https://teleconsul.org:8000/api/user'
    ...
    registrarDoctor=(event) => {
       ...
       console.log(request);
        ...
        axios.post(url, fd, {headers: {
            ...
            alert("El usuario se registró de forma correcta, espera el proceso de aprobación");
                        ...
                        <div className="row">
                            ...
                            <div className="input-group col-lg-12 mb-4">
                             ...
                             <div className="input-group col-lg-12 mb-4">
                                ...
                                <label  className="form-control bg-white border-left-0 border-md centrar" for="documents">Documentos (CV)</label >
                            ...
                            <div className="form-group col-lg-12 mx-auto mb-0">
                                {this.state.terminos ?
                                    <button type="submit" className="btn btn-primary btn-block py-2">
                                        <span className="font-weight-bold">Registrarse</span>
                                    </button>: ""}
                            </div>
                            ...
                            <div className="text-center w-100">
                                <p className="text-muted font-weight-bold">¿Ya tienes cuenta? <a href="/login" className="text-primary ml-2">acceder</a></p>
                            </div>
